...
<footer className="p-8 bg-gray-100 text-gray-600 text-sm border-t border-gray-200">
  <div className="max-w-4xl mx-auto text-center">
    <p className="mb-4 font-medium">
      &copy; {new Date().getFullYear()} Twój Kosmogram. Wszelkie prawa zastrzeżone.
    </p>
    
    {/* Sekcja wymagana przez licencję Swiss Ephemeris */}
    <div className="bg-white/50 p-4 rounded-lg border border-gray-300">
      ...
      <p className="mt-2 text-xs leading-relaxed">
        The Swiss Ephemeris is a professional-standard library for astrological calculations. 
        It is licensed under the <span className="font-semibold">GNU General Public License (GPL)</span>. <br />
        Copyright &copy; by <a 
    ...
    <p className="mt-6 text-[10px] text-gray-400 italic">
      Strona została stworzona w celach edukacyjnych/rozrywkowych. 
